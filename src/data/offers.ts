...
export const activeOffers: Offer[] = [
  ...
  },
  {
    ...
    subtitle: "$3 OFF Orders over $15 with Code: WELCOMELATTE",
    description: "Welcome to LATTE LOCA Specialty Coffee! Get an instant $3 discount on your order.",
    badge: "Code: WELCOMELATTE",
    discountType: "fixed",
    discountValue: 3.0,
    tag: "New Customer",
